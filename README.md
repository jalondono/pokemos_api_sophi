...
# Note
- The production application is deployed in aws ec2 instance. you can access it through this link:
`http://ec2-107-22-53-85.compute-1.amazonaws.com`
...
- To run the tests use the command ` docker exec -it booking-rooms_web_1 python manage.py test core`
